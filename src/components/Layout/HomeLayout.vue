<template>
    <div class="wrapper" :class="{'home-slide-on': commonStore.homeAside}">
        <HomeHeader/>
        <HomeMain/>
        <HomeFooter/>
        <HomeAside/>
        <div class="aside-mask" @click="commonStore.toggleHomeAside"></div>

        <el-backtop :right="100" target=".el-scrollbar__wrap" :bottom="100" :visibility-height="300">
            <div class="back-top">
