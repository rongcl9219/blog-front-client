<template>
    <div>
        ...
        <div class="web-menu-wrap" @click="commonStore.toggleHomeAside">
            <div class="menu-item" @click="pathTo('/')">
                <p class="num">{{ asideInfo.articleCount || '' }}</p>
                <p>文章</p>
            </div>
            <div class="menu-item" @click="pathTo('/classTag')">
                <p class="num">{{ asideInfo.classCount || '' }}</p>
                <p>分类</p>
            </div>
            <div class="menu-item" @click="pathTo('/classTag')">
                <p class="num">{{ asideInfo.tagCount || '' }}</p>
                <p>标签</p>
            </div>
        </div>
        <div class="git-box">
